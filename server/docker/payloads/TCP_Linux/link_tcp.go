// server/docker/payloads/TCP_Linux/link_tcp.go
...
// Auth strings are now defined in link_manager.go (lmAuthPrefix, lmAuthOK)
// to avoid duplication and enable server-side template support
