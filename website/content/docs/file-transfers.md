...
flowchart TB
    ...
    subgraph Server["Server"]
        UWS[WebSocket Service<br/>Assemble in /app/uploads]
        UAH[Agent Handler<br/>Split to 512KB chunks]
    end
...
flowchart TB
    ...
    subgraph Server["Server"]
        DAH[Agent Handler<br/>Write .partN files]
        DTRACK[Download Tracker<br/>Assemble final file]
    end
