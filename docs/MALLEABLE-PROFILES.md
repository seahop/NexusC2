...
```bash
./scripts/nexus-api.py profiles template -o my-profiles.toml
```
...
```bash
./scripts/nexus-api.py profiles upload my-profiles.toml
```
...
**List all profiles:**
```bash
./scripts/nexus-api.py profiles list
```

**List specific profile types:**
```bash
./scripts/nexus-api.py profiles list-get
./scripts/nexus-api.py profiles list-post
./scripts/nexus-api.py profiles list-response
```

**List profile names only:**
```bash
./scripts/nexus-api.py profiles names
```

**Get profile details:**
```bash
./scripts/nexus-api.py profiles get get custom-get
./scripts/nexus-api.py profiles get post custom-post
./scripts/nexus-api.py profiles get response custom-response
```

**Delete a profile:**
```bash
./scripts/nexus-api.py profiles delete get custom-get
./scripts/nexus-api.py profiles delete post custom-post
./scripts/nexus-api.py profiles delete response custom-response
```
...
```bash
./scripts/nexus-api.py --help
./scripts/nexus-api.py profiles --help
```
